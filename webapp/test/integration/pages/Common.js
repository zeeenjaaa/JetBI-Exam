sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("ControlTaskNS/ControlTask-Zenchyk/app", ".html");
		...
		return Opa5.extend("ControlTaskNS.ControlTask-Zenchyk.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["ControlTaskNS/ControlTask-Zenchyk/localService/mockserver"], function (mockserver) {
